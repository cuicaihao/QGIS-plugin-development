...
class SaveAttributes:
    ...
    def run(self):
        ...
        # Clean the content of the comboBox from previous runs
        self.dlg.comboBox.clear()
        # Populate the comboBox with name of all the loaded layers
        ...
        if result:
            ...
            self.iface.messageBar().pushMessage("Success", "Ouput file written at " +
                                                filename, level=Qgis.Success, duration=3)
